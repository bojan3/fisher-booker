...
public class Cottage {
   ...
   public java.util.List<Room> room;
   public java.util.Set<Rule> rule;
   public java.util.Collection<CottageFastReservation> cottageFastReservation;
   public AvailabilityPeriod availabilityPeriod;
   public java.util.Set<CottagePicture> cottagePicture;
   public java.util.Set<CottageReservation> cottageReservation;
